...
if init_from == 'scratch':
    ...
    if meta_vocab_size is None:
        print("defaulting to vocab_size of GPT-2 to 32064 (50257 rounded up for efficiency)")
    ...
    if iter_num % eval_interval == 0 and accelerator.is_main_process:
        ...
        if losses['val'] < best_val_loss or always_save_checkpoint:
            ...
            if iter_num > 0:
                ...
                accelerator.save(checkpoint, os.path.join(out_dir, 'ckpt_'+str(int(time.time()))+'.pt'))
